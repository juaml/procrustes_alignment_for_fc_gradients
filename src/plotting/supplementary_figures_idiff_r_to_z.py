"""Plot identification accuracy for different parameters."""
...
def main(parcellation, alignment):
    ...
    iacc_vars = [x for x in data.columns if "IDiff_r_to_z" in x]
    ...
    with plt.style.context("default.mplstyle"):
        ...
        outname = outpath / f"parc-{parcellation}_supplementary_idiff_r_to_z"
